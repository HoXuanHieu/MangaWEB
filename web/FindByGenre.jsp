<%-- 
    Document   : FindByGenre
    Created on : Jun 30, 2022, 4:31:13 PM
    Author     : Ho Hieu
--%>
    ...
    <body>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <h1 style="font-weight: bold; color: #999896">${genreBook}</h1>
                <hr>
        ...
        <div class="text-center"  style="margin: 50px 0 " >
            ...
            <c:forEach var="j" begin="1" step="1" end="${TotalPage}">                
                <a class="linkDeco" href="SearchForGenre?PageNumber=${j}&genre=${genreBook}" >${j}  </a>
            </c:forEach>
        </div>
    </body>
</html>
