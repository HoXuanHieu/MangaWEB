 ...
 * @author Ho Hieu
 */
public class GetProductsForAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("totalProducts", books.size());
        int page;
        if (pageString == null) {
            page = 1;
        } else {
        ...
        request.getRequestDispatcher("AdminPageProduct.jsp").forward(request, response);
    }
