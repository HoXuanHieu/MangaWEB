...
public class AddBook extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String genre = request.getParameter("Gerne");
        float price = Float.parseFloat(request.getParameter("price"));
        int num = Integer.parseInt(request.getParameter("number"));
        String[] categoryArray = request.getParameterValues("catetory");
        String category = "";
        if (categoryArray != null) {
            ...
            String error = "Vui lòng chọn thể loại!!";
        ...
        DAOUser.addBook(BookId, title, author, genre, price, num, category, "images/" + img_url, description);
